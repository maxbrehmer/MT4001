...
Vi gör var sitt Pearson -respektive Spearman test med nollhypotesen att korrelationen mellan tempreaturen på Norra Halvklotet och Södra Halvklotet året efter är lika med 0 och alternativhypotesen är att korrelationen är skiljd från 0. Det vill säga $H_0: \mu_1 - \mu_2 = 0$. $H_1: \mu_1 - \mu_2 \neq 0$.
 
```{r}
df_next <- subset(df, year <= 2007 & year >= 1982)
 
cor.test(df_next$nh, df_next$shnext, method = "pearson", conf.level = 0.9)
 
cor.test(df_next$nh, df_next$shnext, method = "spearman", conf.level = 0.9)
```
 
Vi ser att både Pearsons och Spearmans korrelationskoefficienter visar på korrelation mellan de två variablerna. Slutsatsen är att vi förkastar nollhypotesen.
