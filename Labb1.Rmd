...
Fördelningstyperna i figur 8 och 9 kan tydligt skilljas åt när stickprovsstorleken överstiger 500, det krävs alltså en mindre stickprovsstorlek när vi jämför exponentialfördelningar med normalfördelningar än jämförelsen med likformig fördelning.
...
Sett till figuren ser vi att Sverige är något mer ölkonsumerande än vinkonsumerande, men är inte extremt åt något håll då vi svenskar dricker mycket av båda dryckerna.

Irland är extremt åt öl-hållet då vi finner dem långt till höger på x-axeln men långt ner på y-axeln. Irländarna älskar alltså sin öl men är inte särskillt förtjusta i vin.

Å andra sidan är Frankrike, Italien och Schweiz väldigt avvikande åt vin-hållet då vi finner dessa länder längst upp till vänster. Gemensamt för de länder som tycker om vin betydligt mer i förhållande till ölkonsumtionen än övriga länder är att de är medelhavsländer med mycket turism.

I figuren syns det att länder med en högre konsumtion av ett slag av alkohol också konsumerar mer av den andra typen och likaså medför en lägre konsumtion av den ena typen en lägre konsumtion av den andra.
